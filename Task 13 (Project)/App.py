...
def insert_data(name, email, score, timestamp, phone=None, address=None):
    insert_sql = "INSERT INTO your_table_name (name, email, score, timestamp, phone, address) VALUES (%s, %s, %s, %s, %s, %s)"
    rec_values = (name, email, score, timestamp, phone, address)
    
    # Debugging: Print the SQL and values
    print(f"Executing SQL: {insert_sql}")
    print(f"Values: {rec_values}")
